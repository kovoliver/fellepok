...
export const userServiceSchema = Joi.object({
    serviceType:Joi.string().empty("").required().messages({
        ...
        "string.empty":"A szolgáltatás típusa nem maradhat üres!"
    }),
    ...
    webpage:Joi.string().regex(/(http|https):\/\/[\w\-\_]{0,255}\.[\w]{2,6}/).messages({
        ...
        "string.regex":"A weboldal formátuma nem megfelelő!",
    ...
    facebook:Joi.string().regex(/https\:\/\/(facebook)\.(com)\/[\w]{1,50}/).messages({
        ...
        "string.regex":"A Facebook oldal formátuma nem megfelelő!",
    ...
    tiktok:Joi.string().regex(/https\:\/\/(tiktok)\.(com)\/[\w]{1,50}/).messages({
        ...
        "string.regex":"A TikTok oldal formátuma nem megfelelő!",
    ...
    youtube:Joi.string().regex(/https\:\/\/(youtube)\.(com)\/[\w]{1,50}/).messages({
        ...
        "string.regex":"A YouTube oldal formátuma nem megfelelő!",
    ...
    instagram:Joi.string().regex(/https\:\/\/(instagram)\.(com)\/[\w]{1,50}/).messages({
        ...
        "string.regex":"Az Instagram oldal formátuma nem megfelelő!",
    ...
    x_twitter:Joi.string().regex(/https\:\/\/(x)\.(com)\/[\w]{1,50}/).messages({
        ...
        "string.regex":"Az X/Twitter oldal formátuma nem megfelelő!",
     ...
     linkedin:Joi.string().regex(/https\:\/\/(linkedin)\.(com)\/[\w]{1,50}/).messages({
        ...
        "string.regex":"A LinkedIn oldal formátuma nem megfelelő!",
