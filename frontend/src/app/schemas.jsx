...
export const regSchema = Joi.object({
    ...
    .messages({
        "any.empty":"A regisztráció típusa mező kötelező!",
...
export const profileSchema = Joi.object({
    title:Joi.string().allow("Dr.", "Prof.").messages({
    ...
    firstName:Joi.string().min(3).empty("").required().messages({
    ...
    lastName:Joi.string().min(3).empty("").required().messages({
        "string.empty":"A vezetéknév mező nem maradhat üresen!",
